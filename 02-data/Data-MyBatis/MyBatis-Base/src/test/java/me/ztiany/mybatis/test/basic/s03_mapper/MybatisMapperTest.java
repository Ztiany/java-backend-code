package me.ztiany.mybatis.test.basic.s03_mapper;
...
public class MybatisMapperTest {
    ...
    public void before() throws IOException {
        //加载核心配置文件
        InputStream in = Resources.getResourceAsStream("MyBatisConfig02_Mapper.xml");
        //创建SqlSessionFactory
    ...
    public void testSelectOrdersWithUser() {
        ...
        List<Order> orderWithUserList = orderMapper.selectOrdersList();
